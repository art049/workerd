...
class Autogate {
 ...
 public:
  ...
  //
  // This is used by the WORKERD_ENABLE_ALL_AUTOGATES environment variable to enable all gates
  // regardless of what's specified in the config file. This can be useful during development
  // to test features that are behind autogates.
  //
 ...
 private:
  bool gates[static_cast<size_t>(AutogateKey::NumOfKeys)];
